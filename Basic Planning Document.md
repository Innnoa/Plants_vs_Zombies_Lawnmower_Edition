...
| Sprint                     | 目标               | 交付物                                                    |      |
| -------------------------- | ------------------ | --------------------------------------------------------- | ---- |
| **Sprint 0**<br>(准备阶段) | 环境搭建、协议定义 | - 开发环境配置完成<br>- Protobuf消息定义<br>- Git仓库建立 |      |
| **Sprint 1**<br>(基础联机) | 实现基本连接与移动 | - 服务器接受连接<br>- 客户端连接成功<br>- 单人移动同步    |      |
| **Sprint 2**<br>(多人同步) | 多玩家状态同步     | - 房间管理功能<br>- 多人实时移动<br>- 基础UI界面          |      |
| **Sprint 3**<br>(核心玩法) | 敌人与战斗         | - 敌人生成与渲染<br>- 碰撞检测<br>- 攻击与伤害            |      |
| **Sprint 4**<br>(成长系统) | 升级与掉落         | - 经验值与升级<br>- 物品掉落<br>- 技能系统雏形            |      |
| **Sprint 5**<br>(优化打磨) | 性能与体验         | - 性能优化<br>- 特效增强<br>- Bug修复                     |      |
| **Sprint 6**<br>(测试发布) | 完整测试与发布     | - 完整游戏流程<br>- 压力测试通过<br>- 可发布版本          |      |
...
1. ✅ 搭建CMake项目，集成Asio和Protobuf
2. ✅ 实现简单TCP服务器（能接受连接）
3. ✅ 定义核心Protobuf消息（与朋友共同完成）
4. ✅ 实现基础游戏循环框架

**Java 开发者**：

1. ✅ 创建LibGDX项目（Desktop平台）
2. ✅ 实现TCP客户端连接
3. ✅ 定义核心Protobuf消息（与朋友共同完成）
4. ✅ 绘制简单的玩家矩形（能移动）
