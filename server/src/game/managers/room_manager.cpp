...
RoomManager::LeaveRoom(uint32_t player_id) { // 离开房间
...
RoomManager::SetReady(uint32_t player_id,
                      const lawnmower::C2S_SetReady &request) {
...
RoomManager::BuildRoomUpdateLocked(const Room &room) const {
  RoomUpdate update;
